class GitHubPortfolio {
    constructor() {
        ...
        // Optimization: Use a Set for O(1) membership checks during repository filtering
    ...
    renderRepositories(repos) {
        ...
        // Optimization: compare ISO-8601 strings directly to avoid repeated Date object creation
    ...
    createProjectCard(repo, isFeatured = false) {
        // Optimization: Reuse pre-initialized formatter instead of creating new Date/locale objects
    ...
    // Optimization: Regex-based escape is significantly faster than creating DOM elements
    escapeHtml(text) {
        const map = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#039;' };
