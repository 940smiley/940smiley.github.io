class GitHubPortfolio {
    constructor() {
        ...
        // Reusable formatter instance to minimize allocations and CPU churn
    ...
    renderRepositories(repos) {
        ...
        // Optimize sort by using string comparison on ISO dates (O(n log n))
        // instead of repeated Date object instantiation inside the comparator.
    ...
    createProjectCard(repo, isFeatured = false) {
        // Use pre-initialized formatter to reduce object creation overhead in render loop
    ...
    /**
     * High-performance HTML escaping using regex to avoid DOM overhead and layout churn.
     */
    escapeHtml(text) {
