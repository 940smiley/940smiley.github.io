class GitHubPortfolio {
    constructor() {
        ...
        // ⚡ Bolt: Use Set for O(1) membership checks during rendering
        this.featuredRepos = new Set(['recoveredtreasures', 'giveawonderfulday', 'trashy-items']);
        // ⚡ Bolt: Reuse Intl.DateTimeFormat to avoid repeated object creation in render loops
    ...
    renderRepositories(repos) {
        ...
        // ⚡ Bolt: Use string comparison for ISO dates to avoid expensive Date object creation
        ...
        sortedRepos.forEach(repo => {
            // ⚡ Bolt: Use O(1) Set membership check
    ...
    // ⚡ Bolt: Fast regex-based HTML escaping to avoid DOM overhead
    escapeHtml(text) {
        const map = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' };
