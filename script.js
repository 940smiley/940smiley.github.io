class GitHubPortfolio {
    constructor() {
        ...
        // Optimization: Use Set for O(1) membership checks during filtering
        this.featuredRepos = new Set(['recoveredtreasures', 'giveawonderfulday', 'trashy-items']);
        // Optimization: Reuse a single Intl.DateTimeFormat instance to minimize CPU churn during rendering loops
    ...
    renderRepositories(repos) {
        ...
        // Optimization: Standard string comparison for ISO-8601 dates is more performant than Date object allocation
        ...
        sortedRepos.forEach(repo => {
            // Optimization: O(1) membership check using Set
    ...
    createProjectCard(repo, isFeatured = false) {
        // Optimization: Reuse a single Intl.DateTimeFormat instance to minimize object allocation and CPU churn
    ...
    escapeHtml(text) {
        // Optimization: Regex-based escaping is more performant than DOM manipulation for simple string sanitization
        const map = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' };
